...
```
        cat > /etc/tower/conf.d/log_locally.conf <__END__
...
```
        cat > /etc/tower/conf.d/log_conf_changes.conf <<__END__
...
```
        cat > /etc/tower/conf.d/log_ldap.conf <<__END__
...
```
        cat > /etc/tower/conf.d/log_permissions.conf <<__END__
